...
async function producerIsStopped() {
...
describe("concat", () => {
    ...
    it("should concat two asynchronous short streams together", (done) => {
        const stream1 = xstream_1.Stream.periodic(25).take(3);
    ...
    it("buffers asynchronous events of second stream until first stream completes", (done) => {
        const sourceStream = xstream_1.Stream.periodic(25);
    ...
    it("unsubscribes and re-subscribes from source streams", (done) => {
        ...
        const producerActiveLog = new Array();
        let producerInterval;
        let producerValue = 0;
        const loggingProducer = {
            start: (listener) => {
