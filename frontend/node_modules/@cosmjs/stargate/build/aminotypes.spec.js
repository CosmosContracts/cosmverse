...
describe("AminoTypes", () => {
    describe("toAmino", () => {
        ...
        it("works for MsgMultiSend", () => {
            const msg = {
                inputs: [
                    { address: "cosmos1pkptre7fdkl6gfrzlesjjvhxhlc3r4gmmk8rs6", coins: proto_signing_1.coins(1234, "ucosm") },
                    { address: "cosmos10dyr9899g6t0pelew4nvf4j5c3jcgv0r73qga5", coins: proto_signing_1.coins(5678, "ucosm") },
                ],
                outputs: [
                    { address: "cosmos1xy4yqngt0nlkdcenxymg8tenrghmek4nmqm28k", coins: proto_signing_1.coins(6000, "ucosm") },
                    { address: "cosmos142u9fgcjdlycfcez3lw8x6x5h7rfjlnfhpw2lx", coins: proto_signing_1.coins(912, "ucosm") },
                ],
            };
            const aminoMsg = new aminotypes_1.AminoTypes().toAmino({
        ...
        it("works for MsgBeginRedelegate", () => {
            const msg = {
                ...
                amount: proto_signing_1.coin(1234, "ucosm"),
            };
            const aminoMsg = new aminotypes_1.AminoTypes().toAmino({
        ...
        it("works for MsgCreateValidator", () => {
            const msg = {
                ...
                value: proto_signing_1.coin(1234, "ucosm"),
            };
            const aminoMsg = new aminotypes_1.AminoTypes().toAmino({
            ...
            const expected = {
                ...
                value: {
                    ...
                    delegator_address: "cosmos1pkptre7fdkl6gfrzlesjjvhxhlc3r4gmmk8rs6",
                    validator_address: "cosmos10dyr9899g6t0pelew4nvf4j5c3jcgv0r73qga5",
                    pubkey: amino_1.encodeBech32Pubkey({ type: "tendermint/PubKeySecp256k1", value: "A08EGB7ro1ORuFhjOnZcSgwYlpe0DSFjVNUIkNNQxwKQ" }, "cosmos"),
                    value: proto_signing_1.coin(1234, "ucosm"),
                },
            };
            expect(aminoMsg).toEqual(expected);
