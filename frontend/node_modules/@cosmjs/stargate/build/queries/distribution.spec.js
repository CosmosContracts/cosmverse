...
async function makeClientWithDistribution(rpcUrl) {
    ...
    return [queryclient_1.QueryClient.withExtensions(tmClient, distribution_1.setupDistributionExtension), tmClient];
}
describe("DistributionExtension", () => {
    const defaultFee = {
        amount: proto_signing_1.coins(25000, "ucosm"),
        gas: "1500000",
    };
    beforeAll(async () => {
        if (testutils_spec_1.simappEnabled()) {
            ...
            const msg = {
                ...
                amount: proto_signing_1.coin(25000, "ustake"),
            };
            const msgAny = {
