...
export default class Sharing extends Vue {
  @Prop({ default: 'Check this cool NFT on #JunoNetwork #Cosmverse' }) label!: string;
  ...
  get twitterUri() {
    return `https://twitter.com/intent/tweet?text=${this.helloText}&via=Cosmverse&url=${this.realworldFullPath}`;
  }
