    ...
    <div class="columns">
      ...
      <div class="column is-2">
        <Sharing v-if="sharingVisible"
          label="Check this awesome Collection on %23JunoNetwork %23Cosmverse"
  ...
  metaInfo() {
    return {
      ...
      meta: [
        ...
        { property: 'og:title', content: this.collection.name || 'Cosmverse cares about environmental impact'},
        { property: 'og:url', content: 'https://www.cosmverse.com/' + this.$route.path },
        { property: 'og:image', content: this.meta.image || 'https://www.cosmverse.com/Cosmverse_carbonless.jpg'},
        { property: 'og:description', content: this.meta.description || 'Creating Carbonless NFTs on Juno'},
        { property: 'twitter:card', content: 'summary_large_image' },
        { property: 'twitter:title', content: this.collection.name || 'Cosmverse cares about environmental impact'},
        { property: 'twitter:description', content: this.meta.description || 'Creating Carbonless NFTs on Juno'},
        { property: 'twitter:image', content: this.meta.image || 'https://www.cosmverse.com/Cosmverse_carbonless.jpg'},
      ]
    }
  },
  components })
