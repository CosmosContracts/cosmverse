<template>
  <div class="container">
    <div class="box">
      <b-message title="Top-up your Juno address (experimental integration)" type="is-info" has-icon>
      ...
      <b-button type="is-primary"
        ...
        + `&hostAppName=Cosmverse`
        + `&hostLogoUrl=https://www.cosmverse.com/Cosmverse_logo_v1_transparent_400px.png`
        + `&finalUrl=https://www.cosmverse.com`
