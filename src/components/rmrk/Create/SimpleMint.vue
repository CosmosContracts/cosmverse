  ...
  metaInfo() {
    return {
      meta: [
        {
          property: 'og:title',
          content: 'Cosmverse | Low fees and low carbon minting'
        },
        { property: 'og:url', content: 'https://www.cosmverse.com' },
        {
        ...
        {
          property: 'og:image',
          content: 'https://www.cosmverse.com/Cosmverse_mint.jpg'
        },
        {
...
export default class SimpleMint extends Mixins(
  ...
  public async constructMeta(): Promise<string> {
    ...
    this.meta = {
      ...
      external_url: `https://www.cosmverse.com`,
      type: this.file.type
    };
